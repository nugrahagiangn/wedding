...
export const mempelaiPria: MempelaDetail = {
  ...
  nickName: "Gian",
  photoUrl: "url('/wedding/images/dist/male.jpeg')?auto=format&fit=crop&q=80&w=800",
...
export const mempelaiWanita: MempelaDetail = {
  ...
  nickName: "Cucu", 
  photoUrl: "url('/wedding/images/dist/female.jpeg')?auto=format&fit=crop&q=80&w=800",
...
export const galleryImages = [
  {
    ...
    url: "url('/wedding/images/dist/male.jpeg')?auto=format&fit=crop&q=80&w=800",
    caption: "Momen Kebersamaan",
  },
  {
    id: "g2",
    // url: "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?auto=format&fit=crop&q=80&w=800",
    url: "url('/wedding/images/dist/bg.jpeg')?auto=format&fit=crop&q=80&w=800",
...
export const loveStories: LoveStory[] = [
  ...
  },
  {
    ...
    imageUrl: "url('/wedding/images/dist/lm.jpeg')?auto=format&fit=crop&q=80&w=800"
  },
  {
    id: "story-4",
...
export const turutMengundang: GuestInviterGroup[] = [
  {
    ...
    names: [
      "Bpk. Enjang Supriyatna dan keluarga",
  ...
  },
  {
    ...
    names: [
      "Teman-teman Alumni (Python) #15 Universitas Nasional PASIM Bandung",
      "Rekan Kerja PT. Changsin Reksa Jaya",
      "Rekan Kerja (Management Information System) PT. Dialogue Group",
      "Teman-teman Olahraga Badminton (Support) PT. Dialogue Group"
    ]
  }
];
